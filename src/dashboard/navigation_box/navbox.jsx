        ...
        <div className='tpae_navigation_cover'>
            ...
            <div className={`tpae_navlinks_cover ${menuToggel ? 'tpae_open_menu' : ''}`}>
                <ul className='tpae_navlinks_inner_cover'>
                    ...
                    <li><Link className={`${location.pathname == '/elementor_templates' ? 'tpae_navlink tpae_active_tab' : 'tpae_navlink'}`} to="/elementor_templates" onClick={() => { setmenuToggel(false) }}>{__('Roll Back', 'tpebl')}</Link></li>
                    {/* } */}
