...
const Extension = (props) => {
    ...
    const [NexterBtn, SetNexterBtn] = useState('Install Nexter Extension Plugin');
                ...
                <div className="she-nexter-content">
                    ...
                    <div className="she-features-ndic">
                        <ul><li>{CheckIcon}{__('22+ Power up Extensions', 'she-header')}</li>
                            <li>{CheckIcon}{__('Works with Popular WordPress Themes', 'she-header')}</li></ul>
                        <ul><li>{CheckIcon}{__('Performance Booster', 'she-header')}</li>
                    ...
                    <div className="she-install-activate">
                        ...
                        <a href='https://nexterwp.com/nexter-extension/features/?utm_source=wpbackend&utm_medium=dashboard&utm_campaign=stickyheader' target="_blank" rel="noopener noreferrer" className='she-nexter-learn'>{__('Learn More', 'she-header')}</a>
                    </div>
                </div>
    ...
    const nexter_Plugin_url = (nxt_url) => {
        const fullUrl = window.location.href;
        const baseUrl = fullUrl.split('wp-admin/')[0] + 'wp-admin/';
        return baseUrl + `admin.php?page=nexter_welcome#/${nxt_url}`;
    }
    ...
    const plus_extension_data = () => {
        ...
        return (
            <>
                                                ...
                                                <div className={`she-part-wid-mng-box ${(data?.tag == 'pro') && !free_pro ? 'she-widget-pro' : ''}`} key={index}>
                                                    <div className='she-wid-in-left'>
                                                        ...
                                                        <div className='she-abt-wid-qik-link-cov'>
                                                            <a href={'https://nexterwp.com/nexter-extension/features/?utm_source=wpbackend&utm_medium=dashboard&utm_campaign=stickyheader'} target="_blank" rel="noopener noreferrer" className='she-nexter-link'>{__('Live Demo', 'she-header')}</a>
                                                            {(data.docUrl) &&
                                                                <span> | </span>
                                                            }
                                                            {data.docUrl &&
                                                                <a href={data.docUrl + '?utm_source=wpbackend&utm_medium=dashboard&utm_campaign=stickyheader'} target="_blank" rel="noopener noreferrer" className='she-nexter-link'>{__('Read Docs', 'she-header')}</a>
                                                            }
                                                        </div>
                                                    </div>
                                                    <div className='she-widget-inner-toggle'>
                                                        <label className="she-nexter-tgl-btn-cover">
                                                            ...
                                                            {!Nextercheck ? (
                                                                ...
                                                                <a className='she-nexter-redirect' href={nexter_Plugin_url(data.category)} target="_blank" rel="noopener noreferrer">
                ...
                {/* {NShowPopup && ( */}
                <div className={`she-nexter-popup ${NShowPopup ? 'is-open' : ''}`} onClick={closePopup}>
                    <div className="she-nexter-bg" onClick={(e) => e.stopPropagation()}>
