    ...
    return (
        <div className='she_no_wid_cover'>
            ...
            <div className='she_btm_nowid_crds'>
                ...
                <div className='she_nowid_info she_field_card she-section-heading-cover'>
                    <svg width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="15.995" cy="16" r="15.68" fill="#fff" strokeWidth=".64" stroke="#9d1a4f" /><path fillRule="evenodd" clipRule="evenodd" d="M17.488 10.02c.357.09.575.451.485.809l-2.666 10.666a.667.667 0 1 1-1.294-.323l2.667-10.667a.667.667 0 0 1 .808-.485Zm-4.357 2.842c.26.26.26.682 0 .943L10.936 16l2.195 2.195a.667.667 0 0 1-.943.943l-2.666-2.666a.667.667 0 0 1 0-.943l2.666-2.667c.26-.26.683-.26.943 0Zm5.724 0c.26-.26.683-.26.943 0l2.667 2.667a.667.667 0 0 1 0 .943l-2.667 2.666a.667.667 0 1 1-.943-.943L21.05 16l-2.195-2.195a.667.667 0 0 1 0-.943Z" fill="#9d1a4f" /><defs><linearGradient id="a" x1="15.995" y1="0" x2="15.995" y2="32" gradientUnits="userSpaceOnUse"><stop stop-color="#6D68FE" /><stop offset="1" stop-color="#B446FF" /></linearGradient><linearGradient id="b" x1="15.993" y1="10" x2="15.993" y2="22" gradientUnits="userSpaceOnUse"><stop stop-color="#6D68FE" /><stop offset="1" stop-color="#B446FF" /></linearGradient></defs></svg>
                ...
                <div className='she_nowid_info she_field_card she-section-heading-cover'>
                    <svg width="33" height="32" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="16.325" cy="16" r="15.68" fill="#fff" stroke="#9d1a4f" strokeWidth=".64" /><path  stroke="url(#b)" strokeWidth=".08" d="M8.365 8.04h15.92v15.92H8.365z" /><path fill="#9d1a4f" d="M12.325 13.056a.29.29 0 0 0 .023.127c.017.04.043.077.077.108a.381.381 0 0 0 .256.096h1.217a.396.396 0 0 0 .392-.335c.133-.877.797-1.516 1.98-1.516 1.012 0 1.938.459 1.938 1.562 0 .848-.551 1.239-1.423 1.832-.993.654-1.78 1.418-1.723 2.657l.004.29a.32.32 0 0 0 .11.233.39.39 0 0 0 .26.096h1.195a.389.389 0 0 0 .261-.098.319.319 0 0 0 .108-.236v-.14c0-.96.403-1.24 1.49-1.987.899-.62 1.835-1.306 1.835-2.749 0-2.02-1.882-2.996-3.943-2.996-1.869 0-3.916.789-4.057 3.056Zm2.297 7.705c0 .712.627 1.239 1.49 1.239.899 0 1.517-.527 1.517-1.24 0-.737-.62-1.256-1.518-1.256-.862 0-1.489.519-1.489 1.257Z" /><defs><linearGradient id="a" x1="16.325" y1="0" x2="16.325" y2="32" gradientUnits="userSpaceOnUse"><stop stop-color="#6D68FE" /><stop offset="1" stop-color="#B446FF" /></linearGradient><linearGradient id="b" x1="16.325" y1="8" x2="16.325" y2="24" gradientUnits="userSpaceOnUse"><stop stop-color="#6D68FE" /><stop offset="1" stop-color="#B446FF" /></linearGradient><linearGradient id="c" x1="16.325" y1="10" x2="16.325" y2="22" gradientUnits="userSpaceOnUse"><stop stop-color="#6D68FE" /><stop offset="1" stop-color="#B446FF" /></linearGradient></defs></svg>
