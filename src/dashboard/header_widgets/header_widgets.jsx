...
const Header_widgets = (props) => {
    ...
    const preview_Plugin_url = (type) => {
        ...
        if (type == 'tpae') {
            ...
            return baseUrl + 'admin.php?page=elementor#/widgets';
        }
                            ...
                            return (
                                <div className='she-catwise-wid-manage-cov' key={index}>
                                    ...
                                    <div className='she-wid-box-cover'>
                                            ...
                                            return (
                                                <div className={`she-part-wid-mng-box ${(data?.tag == 'pro') && !free_pro ? 'she-widget-pro' : ''}`} key={index}>
                                                    <div className='she-wid-in-left'>
                                                        <div className={`she-widgets-tag${data?.tag == 'pro' ? '-pro' : ''}`}>{data.tag}</div>
                                        ...
                                        {TheplusSowPopup && (
                                            <div className="she-tpae-popup">
                                                <div className="she-tpae-popup-bg">
                                        ...
                                        {WdkitPopup && (
                                            <div className="she-tpae-wdkit-popup">
                                                <div className="she-wdkit-content-bg">
