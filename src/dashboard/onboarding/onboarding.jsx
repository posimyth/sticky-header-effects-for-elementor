...
const Onboarding = (props) => {    
    ...
    const [TrueStep, setTrueStep] = useState([
        { id: 'select_mode', step_number: 1, step_name: __('Select Mode', 'tpebl'), active: false },
        { id: 'get_updates', step_number: 2, step_name: __('Get Updates', 'tpebl'), active: false },
        { id: 'install_free_theme_builder', step_number: 3, step_name: __('Install Free Theme Builder', 'tpebl'), active: false },
        { id: 'create_header', step_number: 4, step_name: __('Create Header', 'tpebl'), active: false },
    ]);
    ...
    const select_mode = () => {
        return (
            <div className="she-start-crd-main she-onbsec-cover">
                <h2 className="she-onbrd-crd-h">{__('Select Your Elementor Version', 'tpebl')}</h2>
                <h2 className="she-onbrd-crd-d">{__('We’ve detected your Elementor setup. Choose the right mode to proceed with Sticky Header onboarding.', 'tpebl')}</h2>
                ...
                <div className="she-strt-crd-cover she-whitebg-cover">
                    ...
                    <div className="she-main-cover">
                        ...
                        <div className={`she-strat-card ${'import_web' === selectElementor ? 'tpae-active-board-card' : ''} `} onClick={() => { SetElemetor('elementor_free') }}>
                            ...
                            <h3 className="she-crd-h">{__('Elementor Free', 'tpebl')}</h3>
                        </div>
                    </div>
                    ...
                    <div className="she-main-cover">
                        ...
                        <div className={`she-strat-card ${'ele_widgets' === selectElementor ? 'tpae-active-board-card' : ''}`} onClick={() => { SetElemetor('elementor_pro') }}>
                            ...
                            <h3 className="she-crd-h">{__('Elementor Pro', 'tpebl')}</h3>
                            {/* <p className="tpar-crd-desc">{__('Create your design with our highly customisable widgets', 'tpebl')}</p> */}
                        </div>
                    </div>
                </div>
    ...
    const get_updates = () => {
        ...
        return (
            ...
            <div className="she-stay-upcover she-onbsec-cover">
                ...
                <h2 className="she-onbrd-crd-h">{__('Get Exclusive Elementor Tips, Tricks and Resources Delivered Straight to Your Inbox!', 'tpebl')}</h2>

                <div className="she-whinf-cover she-whitebg-cover">
                    <div className="she-top-stxt">
                        <p className="she-sm-txt">{__('Join our 500K+ Business Owners, Marketers, WordPress users.', 'tpebl')}</p>
                        ...
                        <div className="she-grp-txtico">
                            ...
                            <p className="she-icotxt">{__('NO SPAM GUARANTEE', 'tpebl')}</p>
                        </div>
                    </div>
                    ...
                    <div className="she-staywid-list">
                        ...
                        <label className="she-wid-chk-name" htmlFor="she-agree-ch">
                            {__('Agree to contribute to make Sticky Header better by sharing non-sensitive details.', 'tpebl')}
                        </label>
                    </div>
                </div>
                            ...
                            !subscribeBtncheck ? (
                                isFormValid ? (
                                    ...
                                    <a className="she-pink-common-btn"
                                        ...
                                        {__('Subscribe and Continue', 'tpebl')}
                                    </a>
                                )
                            ) : (
                                <a className="she-pink-common-btn"
    ...
    const install_theme_bulider = () => {
        ...
        const wdkit_poup_accordian = [
            {
                question: "Why do I need the Nexter Extension?",
                answer: "Elementor’s free version doesn’t include a Theme Builder. The Nexter Extension fills this gap, allowing you to design and customize your website’s header, footer, and other theme components without upgrading to Elementor Pro."
            },
            {
                question: "Will this work with any WordPress theme?",
                answer: "Yes, the Nexter Extension is designed to work with any classic WordPress theme. However, for optimal performance, we recommend using it with themes like Hello Elementor, Nexter Theme, Astra, or GeneratePress. If you encounter any issues, please connect with us via our website’s live chat."
            },
            {
                question: "Why do I need the Nexter Extension?",
                answer: "Not at all. The Nexter Extension is designed to integrate seamlessly with your existing website. Your current design and content will remain intact unless you choose to overwrite them with new Theme Builder templates from Nexter."
            }
        ];
            ...
            <div className="she-enbltempl-cover she-onbsec-cover">
                ...
                <div className="she-header-main-cover">
                    <div className="she-header-main-cover-left">
                        <h2 className="she-onbrd-crd-h">{__('You\'re All Set! Now, Create Your Sticky Header', 'tpebl')}</h2>
                        <p className="she-sm-txt">{__('Everything is set up! Click below to open Elementor Theme Builder and create your Sticky Header effortlessly.', 'tpebl')}</p>
                    </div>
                </div>
                <div className="she-btmsm-btn">
    ...
    return (
        ...
        <div className="tpae-onboarding-cover">
            <div className="tpae-steps-cover">
                {TrueStep
                    .filter(step => {
